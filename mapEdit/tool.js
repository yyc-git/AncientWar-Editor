    ...
    var tool = {
        ...
        convertToGrid: function (args) {
            var halfSize = tool.computeOnePixSize() / 2,
                ...
                mapGridWidth = mapData.mapGridWidth,
            ...
            return [math.toFixed(gridX, 5), math.toFixed(gridY, 5)];  //四舍五入，解决浮点数误差的问题
        },
        /**
         * pix转换为方格坐标
         * @param gridX
...
//            y -= gridHeight / 2;    //将坐标点移到方格（包含菱形的矩形方格）左上角
            ...
            return [math.toFixed(x, 5), math.toFixed(y, 5)];   //四舍五入，解决浮点数误差的问题
        },
        ...
        computeOnePixSize: function () {
            return config.map.gridWidth / 97;
//            return 1;
        },
//        /**判断点是否在多边形内
//         *
...
//        },
        isDestOutOfMap: function (dest) {
            return dest[0] < 0 || dest[0] >= mapData.mapGridWidth || dest[1] < 0 || dest[1] >= mapData.mapGridHeight;
        }   ,
...
//            return sprite.isInstanceOf(BuildingSprite);
//        },
//        isUnitSprite: function (sprite) {
//            return sprite.isInstanceOf(CharacterSprite);
//        },
//        isGridSprite: function (sprite) {
//            return sprite.buildableGrid !== undefined;
//        },
